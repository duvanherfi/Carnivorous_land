...
<div class="pedido">
  ...
  <table class="table tabla">
    ...
    <tbody class="cuerpo_pedidos">
      ...
      <tr>
        ...
        <td><button data-id="{{$pendiente->id}}" id="enviarr" type="button" class="btn botones"
            data-dismiss="modal">Entregar</button></td>
  ...
  <br><br>
  <h2 class="row subtitulo-DS pt-3 w-100 m-0">PEDIDOS ENTREGADOS</h2><br>
  ...
  <br>
  <form action="{{ route('VentasAño.pdf') }}" method="post">
    @csrf
    <p>&nbsp Digite el año del informe: <input type="number" min="0" id="informeAño" name="informeAño" style="width:70px;"></p>
    <p>
      <button class="btn btn-sm btn-success" type="submit">
        Descargar Informe de ventas en el año
      </button>
    </p>
  </form>
  <br><br><br><br>
