...
<div id="carousel-example-2" class="carousel slide carousel-fade" data-ride="carousel">
    ...
    <!--/.Slides-->
    <!--Controls-->
    <a class="carousel-control-prev z-index-sup" href="#carousel-example-2" role="button" data-slide="prev">
        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
        <span class="sr-only">Previous</span>
    </a>
    <a class="carousel-control-next z-index-sup" href="#carousel-example-2" role="button" data-slide="next">
